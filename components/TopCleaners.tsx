      ...
      <div className="container">
        ...
        <div className="flex items-center justify-between flex-wrap gap-9">
          <div className="max-w-4xl space-y-3">
            <h2 className="section-title cleaners-title">
              Top cleaners: Masters of cleanliness & care
            </h2>
            <p className="cleaners-text">
        ...
        <div className="grid gap-9 sm:grid-cols-2 lg:grid-cols-4 mt-12">
          {cleaners.map((cleaner) => (
            <div
              key={cleaner.id}
              className="bg-cardClr-1 card shadow-cardClr-2 border-cardClr-2! rounded-xl px-6 py-8"
            >
              {/* Image */}
              ...
              <div className="mt-6 space-y-2.5">
                <h3 className="font-bold text-2xl sm:text-3xl text-cardClr-2">
                  {cleaner.name}
                </h3>
